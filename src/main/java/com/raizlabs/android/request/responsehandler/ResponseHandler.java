 ...
 * return what the {@link com.raizlabs.android.request.RequestCallback} expects.
 */
public interface ResponseHandler<ResponseType, ReturnType> {

    /**
     * Handles the response by converting it from one type to the type that the {@link com.raizlabs.android.request.RequestCallback} handles;
     * @param responseType
     * @return
     */
